...
export const createScheduleReviewSchema: yub.ObjectSchema<CreateScheduleType> = yub.object({
  ...
  capstone_group_id: yub.number().required("Capstone group field is required"),
  evaluation_committee_id: yub.number().required("Evaluation Committee field is required"),
