...
const MainLayout: React.FC = () => {
  ...
  const { data: currentVerifiersData } = useGetVerifiersTopicQuery(
  ...
  useEffect(() => {
    if (currentVerifiersData && currentVerifiersData.data) {
      dispatch(setCurrentVerifiers(currentVerifiersData.data));
    }
  }, [currentVerifiersData, dispatch]);
