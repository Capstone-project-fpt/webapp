...
const generateResources = (num: number): Resource[] => {
    enum type { room = 'room', person = 'person', equipment = 'equipment', service = 'service', other = 'other' }
...
export { generateAppointments, generateResources };
